...
import pandas as pd
from eyedrops_prod.models import EyeDropsFreezingPointDepressionValue
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        df = pd.read_csv('EyeDropsFreezingPointDepression.csv', sep=';')
        for substance, value in zip(df.substance,df.value):
            ...
            model = EyeDropsFreezingPointDepressionValue(substance=substance, value=value)
            #save model instance
            model.save()
